...
public abstract class URLStreamHandler {
	 ...
	 * <code>URL</code> argument.
	 * <p>
	 * The <code>parseURL</code> method of <code>URLStreamHandler</code> parses
	 * the string representation as if it were an <code>http</code> specification.
	 ...
	 * 
	 * @param u
	 *          the <code>URL</code> to receive the result of parsing the spec.
	 * @param spec
	 *          the <code>String</code> representing the URL that must be parsed.
	 * @param start
	 *          the character index at which to begin parsing. This is just past
	 *          the '<code>:</code>' (if there is one) that specifies the
	 *          determination of the protocol name.
	 * @param limit
	 *          the character position to stop parsing at. This is the end of the
	 *          string or the position of the "<code>#</code>" character, if
