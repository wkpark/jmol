...
public class UnitCellIterator implements AtomIndexIterator {
   ...
   * @return
   */
  public UnitCellIterator set(UnitCell unitCell, Atom atom, Atom[] atoms, BS bsAtoms, float distance) {
  ...
  public void setCenter(T3 center, float distance) {
    ...
    System.out.println("minxyz/maxxyz " + minXYZ + " " + maxXYZ);
  ...
  public void addAtoms(BS bsAtoms) {
    ...
    for (int i = bsAtoms.nextSetBit(0); i >= 0; i = bsAtoms.nextSetBit(i + 1)) {
      ...
      String key  = "_" + (int) (pt.x * 100) + "_" + (int) (pt.y * 100) + "_"  + (int) (pt.z * 100) + "_";
    ...
    System.out.println(nAtoms + " unique points found");    
  }
  ...
  public P3 getPosition() {
    System.out.println("UnitCellIterator: " + nFound + " " + getAtom() + " " + t + " " + p);
    return P3.newP(p);
  }
