...
newVar('defaultDropScript','s')
newVar('defaultDrawArrowScale','f')
newVar('defaultLabelPDB','s')
newVar('defaultLabelXYZ','s')
newVar('defaultLattice','c')
newVar('defaultLoadScript','s')
newVar('defaults','s')
newVar('defaultStructureDSSP','b')
...
newVar('drawFontSize','f')
newVar('drawHover','b')
newVar('drawPicking','b')
newVar('dsspCalculateHydrogenAlways','b')
newVar('dynamicMeasurements','_see {#.measure~}')
newVar('echo','vv')
newVar('echoCallback','s')
newVar('edsUrlCutoff','s')
newVar('edsUrlFormat','s')
newVar('edsUrlFormatDiff','s')
...
newVar('energyUnits','s')
newVar('exportDrivers','s')
newVar('exportScale','f')
newVar('evalCallback','s')
...
newVar('forcefield','s')
newVar('fractionalRelative','_removed in Jmol 14.1.16')
...
newVar('imageState','b')
newVar('isKiosk','b')
newVar('isosurfaceKey','b')
newVar('isosurfacePropertySmoothing','b')
newVar('isosurfacePropertySmoothingPower','i')
...
newVar('labelOffsetAbsolute','ix iy')
...
newVar('legacyJavaFloat','b')
newVar('loadAtomDataTolerance','f')
newVar('loadLigandFormat','s')
newVar('loadFormat','s')
...
newVar('multipleBondBananas','b')
newVar('multipleBondRadiusFactor','f')
newVar('multipleBondSpacing','f')
newVar('navFPS','i')
...
newVar('navY','f')
newVar('navZ','f')
newVar('nihResolverFormat','s')
newVar('nmrURLFormat','s')
newVar('partialDots','b')
newVar('particleRadius','i')
newVar('pathForAllFiles','s')
newVar('pdbAddHydrogens','b')
...
newVar('showModulationVectors','b')
...
newVar('structureModifiedCallback','s')
newVar('syncCallback','s')
...
newVar('timing','_showTiming')
newVar('toggleLabel','_labelToggle')
newVar('traceAlpha','b')
newVar('translucent','b')
...
newVar('vdw','JMOL,PROBE')
newVar('vectorScale','f')
newVar('vectorTrail','f')
newVar('vectorsCentered','b')
newVar('vectorSymmetry','b')
