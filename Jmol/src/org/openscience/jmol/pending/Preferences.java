...
public class Preferences extends JDialog {
    ...
    private static int     InterpolationFrames;
    ...
    private JSlider vsSlider, vfSlider, ifSlider;
    ...
    private static void defaults() {
        ...
        props.put("InterpolationFrames", "0");
    ...
    public Preferences(JFrame f, displayPanel dp) {
        ...
        JPanel interpolate = buildInterpolatePanel();
        ...
        tabs.addTab(jrh.getString("interpolateLabel"), null, interpolate );
    ...
    public JPanel buildInterpolatePanel() {
        JPanel interpolatePanel = new JPanel();
        interpolatePanel.setLayout(new GridLayout(0,1));
        
        JPanel notePanel = new JPanel();
        notePanel.setLayout(new BorderLayout());
        notePanel.setBorder(new EtchedBorder());
        JLabel noteLabel = new JLabel(jrh.getString("interpNoteLabel"));
        notePanel.add(noteLabel,BorderLayout.CENTER);
        interpolatePanel.add(notePanel);
        
        JPanel ifPanel = new JPanel();
        ifPanel.setLayout(new BorderLayout());
        ifPanel.setBorder(new TitledBorder(jrh.getString("interpFrameLabel")));      
        ifSlider = new JSlider(JSlider.HORIZONTAL, 0, 20, 
                               Animate.getNumberExtraFrames());
        ifSlider.putClientProperty("JSlider.isFilled", Boolean.TRUE);
        ifSlider.setPaintTicks(true);
        ifSlider.setMajorTickSpacing(2);
        ifSlider.setPaintLabels(true);
        ifSlider.addChangeListener(new ChangeListener() {
                public void stateChanged(ChangeEvent e) {
                    JSlider source = (JSlider)e.getSource();
                    InterpolationFrames = source.getValue();
                    Animate.setNumberExtraFrames(InterpolationFrames);
                    props.put("InterpolationFrames", 
                              Integer.toString(InterpolationFrames));
                }
            });
        
        ifPanel.add(ifSlider,BorderLayout.SOUTH);
        interpolatePanel.add(ifPanel);
        
        return interpolatePanel; 
    }
    ...
    public void SavePressed() {
        ...
        try {
            ...
            //deprecated in 1.2.  We should use "store", but this is 
            //supposed to work in 1.1 also.
    ...
    public void ResetPressed() { 
        ...
        ifSlider.setValue(Animate.getNumberExtraFrames());
        SavePressed();
        return;
    }
    ...
    void initVariables() {
        ...
        InterpolationFrames = Integer.getInteger("InterpolationFrames").intValue();
