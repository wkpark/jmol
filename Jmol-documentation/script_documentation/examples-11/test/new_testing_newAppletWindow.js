...
function newAppletWindow() {
 jmolSetDocument(0)
 //jmolSetLogLevel(5)
 var script = ';script "javascript:getState()"'
 var html = '<html><title>Jmol Popup Model</title><body>'
	+'<head><script type="text/javascript">'
	+'_jmol = new Array();'
	+'function refreshModelX(){'
	+' document.getElementById("jmolAppletX").script(getState())'
	+'}'
	+'function getState(){'
	+' return opener.jmolGetPropertyAsString("stateInfo")+";zoomLarge = false"'
	+'}'
	+'</script>'
	+'<body><h3><a href="javascript:refreshModelX()">refresh model</a>'
	+' <a href="javascript:alert(\'Click on &quot;refresh model&quot; at any time to see the model in its current state in this window. You may refresh the model as often as desired, and you may resize this model as often as you like.\')">note</a></h3>'
...
function newAppletWindow() {
 ...
 var html = '<html><title>Jmol Popup Model</title><body>'
	...
	+'}'
	+'</script>'
	+'<body><h3><a href="javascript:document.getElementById(\'jmolAppletX\').script(opener.jmolGetPropertyAsString(\'stateInfo\')+\';zoomLarge = false\')">refresh model</a>'
	+' <a href="javascript:alert(\'Click on &quot;refresh model&quot; at any time to see the model in its current state in this window. You may refresh the model as often as desired, and you may resize this model as often as you like.\')">note</a></h3>'
	+jmolApplet(["100%","90%"],script,"X").replace(/allback/g,"allbackDISABLED")
	+'</body></html>'
 //alert(html)
