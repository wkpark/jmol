/*
 * @(#)MeasurementFactory.java    1.0 99/08/13
 *
...
class MeasurementFactory {
    ...
    static Measurement createMeasurement(int[] atoms) {
        
        int l = atoms.getLength();
        
        if ( l == 2 ) {
            return new Distance(atoms);
        } else if (l == 3) {
            return new Angle(atoms);
        } else if (l == 4) {
            return new Dihedral(atoms);
	}
