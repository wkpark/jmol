...
public class WebExport extends JPanel {
  ...
  public WebExport(JmolViewer viewer) {
    ...
    mainTabs.addTab("ScriptButton Jmol", ((ScriptButtons) webPanels[1])
        .getPanel());

    showMoleculesAndOrbitals = (runStatus == STAND_ALONE
  ...
  public static String TimeStamp_WebLink() {
    ...
    out = out
        + " generated by export to web function of (<a href=\"http://www.uwosh.edu/faculty_staff/gutow/Jmol_Web_Page_Maker.shtml\">Jmol</a>) on "
        + now_string + ". </small><small><br>";
    return out;
  }
  ...
  //can we do this? -BH
  //This does seem to work.  However, the ScriptButtons and PopInJmol don't make much sense with
  //the standalone application. The ones for reading the files do.  If we include reading stored
  //states, it will eventually make sense for all possibilities.-JG
