...
abstract public class JSVGenericPopup extends GenericPopup {
  ...
  private void setEnables(JSVPanel jsvp) {
    ...
    setItemEnabled("Predicted_Solution_Colour_(interpolated)", isSingle
        && spec0.canShowSolutionColor());
...
// not implemented -- see   ScriptToken.COMPOUNDMENUON()  
//  /**
//   * @param panelNodes 
//   * @param allowCompoundMenu  
//   */
