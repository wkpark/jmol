...
/****************************************************************
 * AtomSet is used as objects in the tree representation of
 * the AtomSetCollection.
 ****************************************************************/
public class AtomSet {
	/**
	 * The atomSetIndex in the AtomSetCollection
	 */
	private int atomSetIndex;
	private String atomSetName;
	
	/**
	 * @param atomSetIndex The index of the AtomSet
	 */
