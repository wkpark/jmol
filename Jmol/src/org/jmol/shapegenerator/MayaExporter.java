...
class MayaExporter extends Exporter {

  MayaExporter(Graphics3D g3d, StringBuffer output) {
    super(g3d, output);
  ...
  void renderBall(Atom atom, short colix) {
  ...
  void renderCylinder(Atom atom1, Atom atom2, short colix1, short colix2,
  ...
  void renderCylinder(Point3f pt1, Point3f pt2, short colix, byte endcaps,
                      int madBond) {
    nCyl++;
  ...
  Vector3f getRotation(Vector3f v) {
    tempR.set(v);
    tempR.normalize();
  ...
  void fillSphereCentered(int radius, Point3f pt, short colix) {
   //not a mad -- a number of pixels?  
  }
  
  void fillTriangle(Point3f ptA, short colixA, short nA, 
