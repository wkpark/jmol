...
//    { "pickDraw" , "set picking draw" },
    ...
    { "surfaceMenu" , "surfDots surfVDW surfSolventAccessible12  surfSolventAccessible14 surfSolvent12 surfSolvent14 surfMolecular surfMEP surfMoComputedMenu - surfOpaque surfTranslucent surfOff" },
    ...
    { "surfSolvent12", "isosurface delete resolution 0 solvent 1.2 translucent" },
    { "surfSolvent14", "isosurface delete resolution 0 solvent 1.4 translucent" },
    { "surfSolventAccessible12", "isosurface delete resolution 0 sasurface 1.2 translucent" },
    { "surfSolventAccessible14", "isosurface delete resolution 0 sasurface 1.4 translucent" },
...
//    { "pickDraw" , GT._("moves arrows") },
    ...
    { "surfSolvent12", GT._("Solvent Surface ({0}-Angstrom probe)", new Object[] { "1.2" } ) },
    { "surfSolvent14", GT._("Solvent Surface ({0}-Angstrom probe)", new Object[] { "1.4" } ) },
    { "surfSolventAccessible12",  GT._("Solvent-Accessible Surface (VDW + {0} Angstrom)", new Object[] { "1.2" } ) },
    { "surfSolventAccessible14",  GT._("Solvent-Accessible Surface (VDW + {0} Angstrom)", new Object[] { "1.4" } ) },
    ...
    { "axesByAngstromMenu", GT._("Angstrom Width") },
    { "axes10a", GT._("{0} \u00C5", new Object[]{ "0.10" })},
    { "axes20a", GT._("{0} \u00C5", new Object[]{ "0.20" })},
    { "axes25a", GT._("{0} \u00C5", new Object[]{ "0.25" })},
    { "axes50a", GT._("{0} \u00C5", new Object[]{ "0.50" })},
    { "axes100a", GT._("{0} \u00C5", new Object[]{ "1.0" })},
    ...
    { "bbcage10a", GT._("{0} \u00C5", new Object[]{ "0.10" })},
    ...
    { "uccageByAngstromMenu", GT._("Angstrom Width") },
    { "uccage10a", GT._("{0} \u00C5", new Object[] { "0.10" })},
    { "uccage20a", GT._("{0} \u00C5", new Object[] { "0.20" })},
    { "uccage25a", GT._("{0} \u00C5", new Object[] { "0.25" })},
    { "uccage50a", GT._("{0} \u00C5", new Object[] { "0.50" })},
    { "uccage100a", GT._("{0} \u00C5", new Object[] { "1.0" })},
