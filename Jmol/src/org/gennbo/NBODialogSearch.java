...
abstract class NBODialogSearch extends NBODialogView {
  ...
  private JPanel opList;
  private JRadioButton[] rBtns = new JRadioButton[12];
  ...
  private String[] keyW = { "NPA    : Atomic and NAO properties",
  ...
  protected JPanel buildSearchPanel() {
    ...
    inputFileHandler = new NBOFileHandler((inputFileHandler == null ? ""
        : inputFileHandler.jobStem), "47", NBOFileHandler.MODE_SEARCH, "47",
        (NBODialog) this);
    ...
    nboRb.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
        showJmolNBO("NBO", orb.getSelectedIndex() + 1);
      }
    });
    ...
    topBox.add(new HelpBtn("a") {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        try {
          ...
          alertError("Could not open browser");
  ...
  protected void buildHome() {
    ...
    keyProp = "";
    String[] keyWords = { "NPA", "NBO", "BEND", "E2PERT", "NLMO", "CMO", "NRT",
        "STERIC", "DIPOLE", "OPBAS", "B1B2" };
      ...
      btn.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent arg0) {
          if (nboService.isWorking) {
            alertError("Please wait for NBOServe to finish working");
            return;
          }
          if (index < 5)
  ...
  protected void getListSearch(final String get,
    ...
    if (keywordNumber >= KEYWD_OPBAS) {
      ...
      String tmpCmd = "o";
      JComboBox<String> tmpBas = ((get.startsWith("c") && keywordNumber == KEYWD_BAS1BAS2) ? bas2
          : basis);
  ...
  protected void keywordClicked(int index) throws IllegalArgumentException {
    ...
    case KEYWD_DIPOLE:
      ...
      basis.setSelectedIndex(7);
      keyProp = "DIPOLE";
      setKeyword("b o u".split(" "), new String[] { "Basis: ", "Orbital: ",
          "Unit:" });
      changeKey(dip);
      break;
    case KEYWD_OPBAS:
    ...
    loadModelFileQueued(
        NBOFileHandler.newNBOFile(inputFileHandler.inputFile, "" + fileNum),
        true, false);
    if (keywordNumber == KEYWD_CMO)
      loadModelFileQueued(
          NBOFileHandler.newNBOFile(inputFileHandler.inputFile, "36"), true,
          true);
  ...
  protected void setKeyword(final String[] get, final String[] labs) {
    ...
    for (int i = 0; i < labs.length; i++) {
      ...
      if (key.equals("b") || key.equals("s")) {
        ...
        if (keywordNumber == KEYWD_CMO) {
          ...
          b.add(new JLabel(basis.getSelectedItem().toString()));
        ...
        orb2.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            orbPick();
            if (key.equals("a")) {
              showJmolMO("NBO", list1.getSize() + 1 + orb2.getSelectedIndex());
    ...
    settingsBox.add(l, BorderLayout.WEST);
    settingsBox.add(l2, BorderLayout.CENTER);
  }
  ...
  protected void getSearchValue(int op) {
    ...
    if (isLabel) {
      relabel = true;
      nboService
          .rawCmdNew("s", sb, NBOService.MODE_LABEL, null, "Getting list");
    } else if (isLabelBonds) {
      relabel = true;
      nboService.rawCmdNew("s", sb, NBOService.MODE_LABEL_BONDS, null,
          "Getting list");
    } else {
      nboService.rawCmdNew("s", sb, NBOService.MODE_VALUE, null,
          "Getting value");
    }
  ...
  protected void notifyPick_s(String atomno) {
    ...
    try {
      ...
      if (keywordNumber == KEYWD_NBO || keywordNumber == KEYWD_BEND
        ...
        pickAtomic(atomno, list1, orb);
        return;
      }
      if (keywordNumber == KEYWD_CMO) {
        pickAtomic(atomno, list2, orb2);
        return;
      }
    } catch (NumberFormatException e) {
      String[] tok = atomno.split(",");
      if (tok.length < 2) {
        pickAtomic(atomno, alphaList, orb);
        return;
      }
      ...
      case KEYWD_DIPOLE:
      case KEYWD_CMO:
        pickNBO(tok2[2], tok2[5], list1, orb);
        break;
      case KEYWD_BEND:
        pickNHO(tok2[2], tok2[5], list1, orb);
        break;
      case KEYWD_NRT:
        tok = atomno.split(",");
      ...
      case KEYWD_STERIC:
        ...
        if (str.contains(bond)) {
          pickNBO(tok2[2], tok2[5], list2, orb2);
          return;
        }
        if (!secondPick)
          pickNBO(tok2[2], tok2[5], list2, orb2);
      ...
      case KEYWD_BAS1BAS2:
        ...
        case 4:
          if (!secondPick)
            pickNHO(tok2[2], tok2[5], list2, orb2);
          else
            pickNHO(tok2[2], tok2[5], list1, orb);
          secondPick = !secondPick;
          break;
