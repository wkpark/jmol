...
class JmolPanel extends JPanel implements SplashInterface {
  ...
  JmolPanel(JmolApp jmolApp, Splash splash, JFrame frame, JmolPanel parent,
  ...
  static void startJmol(JmolApp jmolApp) {
