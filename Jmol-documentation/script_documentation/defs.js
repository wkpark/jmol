...
newDef('._mouse_action','any double-quoted combination of a control code (CTRL, ALT, or SHIFT) with a mouse button (LEFT, MIDDLE, RIGHT, or WHEEL) an action (DOWN, DRAG, UP, CLICK), and a either SINGLE or DOUBLE.','mouse-action','is')
//newDef('._jmol_action','[||_assignNew            |_dragDrawPoint        |_pickLabel            |_rotateZ              |_spinDrawObjectCW     || |_center               |_dragLabel            |_pickMeasure          |_rotateZorZoom        |_stopMotion           || |_clickFrank           |_dragMinimize         |_pickNavigate         |_select               |_swipe                || |_pickConnect          |_dragMinimizeMolecule |_pickPoint            |_selectToggleOr       |_translate            || |_deleteAtom           |_dragSelected         |_popupMenu            |_setMeasure           |_wheelZoom            || |_deleteBond           |_dragZ                |_reset                |_slab                 |&nbsp;|| |_depth                |_navTranslate         |_rotate               |_slabAndDepth         |&nbsp;|| |_dragAtom             |_pickAtom             |_rotateBranch         |_slideZoom            |&nbsp;|| |_dragDrawObject       |_pickIsosurface       |_rotateSelected       |_spinDrawObjectCCW    |&nbsp;||]','jmol-action','is one of ')
newDef('._jmol_action','<table><tr><td>_assignNew</td><td> ,_dragDrawPoint</td></tr></table>','jmol-action','is one of ')
