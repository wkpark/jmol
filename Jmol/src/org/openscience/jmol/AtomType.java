...
public class AtomType {
  ...
  private static Image SphereSetup(DisplaySettings settings,
          Color ballColor) {
      ...
      for (int k2 = -b; k2 <= b; k2++) {
        ...
        if (len1 <= b) {
          ...
          if (len2 < 0.995f) {
            ...
            R2 = (int) ((float) (ballColor.getRed() * 155) * len2 + 100.0
                    + len5);
            G2 = (int) ((float) (ballColor.getGreen() * 155) * len2 + 100.0
                    + len5);
            B2 = (int) ((float) (ballColor.getBlue() * 155) * len2 + 100.0
                    + len5);
            R2 = Math.min(R2, 255);
            G2 = Math.min(G2, 255);
            B2 = Math.min(B2, 255);
  ...
  public void paint(Graphics gc, DisplaySettings settings, int x, int y,
    ...
    int diameter = (int) (2.0f
                     * settings.getCircleRadius(z, baseType.getVdwRadius()));
