 ...
 * @author u6x8497
 */
public class DistanceJMolecule {
  ...
  public DistanceJMolecule(AtomContainer mol) {
    this.mol = mol;
  }

  public DistanceJMolecule(AtomContainer mol, String[] labelArray) {
    this.mol = mol;
  ...
  private class DihedralCouple {
    ...
    private Vector3d getVector3d(Atom atom2, Atom atom1) {
      Vector3d vector = new Vector3d(atom2.getX3d() - atom1.getX3d(),
          atom2.getY3d() - atom1.getY3d(), atom2.getZ3d() - atom1.getZ3d());
      return vector;
    }
  }
}
