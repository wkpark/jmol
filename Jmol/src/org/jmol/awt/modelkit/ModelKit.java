...
public class ModelKit extends JDialog implements JmolModelKitInterface {
  ...
  /* (non-Javadoc)
   * @see org.jmol.awt.modelkit.JmolModelKitInterface#getModelKit(org.jmol.viewer.Viewer, javax.swing.JFrame)
   */
  ...
  /* (non-Javadoc)
   * @see org.jmol.awt.modelkit.JmolModelKitInterface#getMenus(boolean)
   */
  ...
  /* (non-Javadoc)
   * @see org.jmol.awt.modelkit.JmolModelKitInterface#show(int, int, java.lang.String)
   */
