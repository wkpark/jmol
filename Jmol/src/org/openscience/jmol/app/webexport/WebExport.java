...
public class WebExport extends JPanel implements WindowListener {
  ...
  private WebExport(Viewer vwr, HistoryFile hFile) {
    ...
    popInWidth = PT.parseInt(historyFile.getProperty("webMakerPopInWidth",
        "300"));
    popInHeight = PT.parseInt(historyFile.getProperty("webMakerPopInHeight",
        "300"));
    ...
    showMoleculesAndOrbitals = (runStatus == STAND_ALONE || WebPanel
        .checkOption(vwr.getP("webMakerAllTabs")));
  ...
  static String TimeStamp_WebLink() {
    return GT
        .o(GT
            .$("Page skeleton and JavaScript generated by the Export to Web module of {0} on {1}."),
            new String[] {
                " <a href=\"http://jmol.sourceforge.net\">Jmol "
                    + Viewer.getJmolVersion() + "</a> ",
  ...
  public static WebExport createAndShowGUI(Viewer vwr, HistoryFile historyFile,
                                           String wName) {
