...
public class WebExport extends JPanel {
  ...
  public WebExport(JmolViewer viewer) {
    ...
    mainTabs.addTab("Log", (new LogPanel()).logPanel());
  ...
  public static String TimeStamp_WebLink() {
    ...
    out += " generated by a java program (<a href=\"http://www.uwosh.edu/faculty_staff/gutow/Jmol_Web_Page_Maker.shtml\">Jmol_Web_Page_Maker</a>) on "
