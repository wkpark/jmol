...
public class Token {
  ...
  final static String[] astrType = { "nada", "identifier", "integer",
      "decimal", "string", "seqcode", "list", "point", "plane", "keyword" };
   ...
   * bit flags:
   * 
   * 3 2 1 0 0987654321098765432109876543210 x command xx atomExpressionCommand
   * x x implicitStringCommand x x mathExpressionCommand xx x flowCommand x
   * noeval x noArgs x defaultON xxxxxxxxxxxx uniqueID (may include math flags)
   * 
   * 
   * math bit flags:
   * 
   * 3 2 1 0 0987654321098765432109876543210 FFFF FFFF FFFF FFFF x expression xx
   * predefined set x x atomproperty xx x stringproperty x x x intproperty x x x
   * floatproperty x x mathproperty x x mathfunc
   * 
   * 
   * xxxxx unique id 1 to 0x1F (31) x min x max xx minmaxmask (all) x vibflag x
   * settable xxx maximum number of parameters for function
   * 
   * 3 2 1 0 0987654321098765432109876543210 x x mathop x x x comparator xxxx
   * unique id (0 to 15) xxxx precedence
   * 
   * 
   * parameter bit flags:
   * 
   * 3 2 1 0 0987654321098765432109876543210 x setparam "set THIS ...." x misc
   */
  ...
  // this implicitString flag indicates that then entire command is an implied
  // quoted string
  ...
  public final static int strproperty = (1 << 23) | atomproperty; // string
                                                                  // property
  public final static int intproperty = (1 << 24) | atomproperty; // int
                                                                  // parameter
  public final static int floatproperty = (1 << 25) | atomproperty; // int
                                                                    // parameter

  public final static int PROPERTYFLAGS = strproperty | intproperty
      | floatproperty;
  ...
  final public static int unitcell = command | 64 | setparam | expression
  ...
  final static int leftdivide = 3 | mathop | 8 << 4; // quaternion1 \
                                                     // quaternion2
  ...
  // .min and .max, and .all are bitfields added to a preceding property
  // selector
  ...
  public final static int vibflag = 1 << 7; // quick check that there is no need
                                            // to taint atom position
  ...
  final public static int boundbox = 9 | mathproperty | setparam | command
      | defaultON;
  ...
  // occupancy, radius, and structure are odd, because they takes different
  // meanings when compared

  final public static int occupancy = intproperty | floatproperty | 2
      | settable;
  public final static int radius = intproperty | floatproperty | 1 | setparam
      | settable;
  final public static int structure = intproperty | strproperty | 3 | command;

  // any new int, float, or string property should be added also to
  // LabelToken.labelTokenIds
  ...
  final public static int color = intproperty | 6 | command | setparam
      | settable;
  ...
  public final static int property = floatproperty | 13 | mathproperty
      | setparam | settable;
  final public static int spacefill = floatproperty | 14 | command | defaultON
      | settable;
  ...
  public final static int label = 7 | 1 << 9 | mathfunc | mathproperty
      | strproperty | settable | implicitStringCommand | defaultON | setparam;
  ...
  final public static Token tokenExpressionBegin = new Token(expressionBegin,
      "expressionBegin");
  final public static Token tokenExpressionEnd = new Token(expressionEnd,
      "expressionEnd");
  ...
  final private static Object[] arrayPairs = {
      ...
      null,
      "geosurface",
      new Token(geosurface),
      "getproperty",
      new Token(getproperty),
      "goto",
      new Token(gotocmd),
      "halo",
      new Token(halo),
      ...
      "invertSelected",
      new Token(invertSelected),
      "isosurface",
      new Token(isosurface),
      "javascript",
      new Token(javascript),
      "label",
      new Token(label),
      "labels",
      null,
      "lcaocartoon",
      new Token(lcaocartoon),
      "lcaocartoons",
      null,
      "load",
      new Token(load),
      ...
      new Token(print),
      "quaternion",
      new Token(quaternion),
      "quaternions",
      null,
      "quit",
      new Token(quit),
      "ramachandran",
      new Token(ramachandran),
      "rama",
      null,
      "refresh",
      new Token(refresh),
      ...
      new Token(specular),
      "specularPercent",
      new Token(specpercent),
      "specularPower",
      new Token(specpower),
      "specpower",
      null,
      "specularExponent",
      new Token(specexponent),
      ...
      new Token(symmetry),
      "spaceGroup",
      new Token(spacegroup),
      "transform",
      new Token(transform),
      "translation",
      new Token(translation),
      "url",
      new Token(url),
      ...
      "absolute", new Token(absolute), "add", new Token(add), "adpmax",
      new Token(adpmax), "adpmin", new Token(adpmin), "all", tokenAll,
      "altloc", new Token(altloc), "altlocs", null, "amino", new Token(amino),
      "angle", new Token(angle), "array", new Token(array), "atomID",
      new Token(atomID), "_atomID", null, "_a", null, "atomIndex",
      new Token(atomIndex), "atomName", new Token(atomName), "atomno",
      new Token(atomno), "atomType", new Token(atomType), "atomx",
      new Token(atomX), "atomy", new Token(atomY), "atomz", new Token(atomZ),
      "average", new Token(average), "babel", new Token(babel), "back",
      new Token(back), "backlit", new Token(backlit), "bondCount",
      new Token(bondcount), "bottom", new Token(bottom), "branch",
      new Token(branch), "carbohydrate", new Token(carbohydrate), "cell",
      new Token(cell), "chain", new Token(chain), "chains", null, "clear",
      new Token(clear), "clickable", new Token(clickable), "clipboard",
      new Token(clipboard), "connected", new Token(connected), "constraint",
      new Token(constraint), "contourLines", new Token(contourlines), "coord",
      new Token(coord), "coordinates", null, "coords", null, "cos",
      new Token(cos), "cross", new Token(cross), "covalent",
      new Token(covalent), "defaultColors", new Token(defaultColors),
      "direction", new Token(direction), "displacement",
      new Token(displacement), "displayed", new Token(displayed), "distance",
      new Token(distance), "div", new Token(div), "DNA", new Token(dna),
      "dotted", new Token(dotted), "element", new Token(element), "elemno",
      new Token(elemno), "_e", null, "fill", new Token(fill), "find",
      new Token(find), "fixedTemperature", new Token(fixedtemp),
      "formalCharge", new Token(formalCharge), "charge", null, "front",
      new Token(front), "frontlit", new Token(frontlit), "frontOnly",
      new Token(frontonly), "fullylit", new Token(fullylit), "fx",
      new Token(fracX), "fy", new Token(fracY), "fz", new Token(fracZ), "fxyz",
      new Token(fracXyz), "group", new Token(group), "groups", null, "group1",
      new Token(group1), "groupID", new Token(groupID), "_groupID", null, "_g",
      null, "groupIndex", new Token(groupindex), "hetero", new Token(hetero),
      "hidden", new Token(hidden), "hydrogen", new Token(hydrogen),
      "hydrogens", null, "identify", new Token(identify), "ident", null,
      "info", new Token(info), "insertion", new Token(insertion), "insertions",
      null, "ionic", new Token(ionic), "isaromatic", new Token(isaromatic),
      "Jmol", new Token(jmol), "join", new Token(join), "last",
      new Token(last), "left", new Token(left), "length", new Token(length),
      "lines", new Token(lines), "list", new Token(list), "max",
      new Token(max), "mep", new Token(mep), "mesh", new Token(mesh), "min",
      new Token(min), "mode", new Token(mode), "molecule", new Token(molecule),
      "molecules", null, "monomer", new Token(monomer), "mul", new Token(mul),
      "next", new Token(next), "noDots", new Token(nodots), "noFill",
      new Token(nofill), "noMesh", new Token(nomesh), "none", new Token(none),
      "null", null, "inherit", null, "normal", new Token(normal),
      "noContourLines", new Token(nocontourlines), "notFrontOnly",
      new Token(notfrontonly), "noTriangles", new Token(notriangles),
      "nucleic", new Token(nucleic), "occupancy", new Token(occupancy), "off",
      tokenOff, "false", null, "on", tokenOn, "true", null, "only",
      new Token(only), "opaque", new Token(opaque), "partialCharge",
      new Token(partialCharge), "phi", new Token(phi), "plane",
      new Token(plane), "play", new Token(play), "playRev", new Token(playrev),
      "point", new Token(point), "pointGroup", new Token(pointgroup),
      "polymerLength", new Token(polymerLength), "previous", new Token(prev),
      "prev", null, "property", new Token(property), "protein",
      new Token(protein), "psi", new Token(psi), "purine", new Token(purine),
      "pyrimidine", new Token(pyrimidine), "random", new Token(random),
      "range", new Token(range), "rasmol", new Token(rasmol), "replace",
      new Token(replace), "resno", new Token(resno), "resume",
      new Token(resume), "rewind", new Token(rewind), "right",
      new Token(right), "RNA", new Token(rna), "rubberband",
      new Token(rubberband), "saSurface", new Token(sasurface), "selected",
      new Token(selected), "shapely", new Token(shapely), "sidechain",
      new Token(sidechain), "sin", new Token(sin), "site", new Token(site),
      "size", new Token(size), "solid", new Token(solid), "solvent",
      new Token(solvent), "specialPosition", new Token(specialposition),
      "sqrt", new Token(sqrt), "split", new Token(split), "straightness",
      new Token(straightness), "sub", new Token(sub), "substructure",
      new Token(substructure), "surface", new Token(surface),
      "surfaceDistance", new Token(surfacedistance), "symop", new Token(symop),
      "temperature", new Token(temperature), "relativetemperature", null,
      "thisModel", new Token(thismodel), "top", new Token(top), "torsion",
      new Token(torsion), "translucent", new Token(translucent), "triangles",
      new Token(triangles), "trim", new Token(trim), "type", new Token(type),
      "ux", new Token(unitX), "uy", new Token(unitY), "uz", new Token(unitZ),
      "uxyz", new Token(unitXyz), "user", new Token(user), "valence",
      new Token(valence), "vanderWaals", new Token(vanderwaals), "vdw", null,
      "visible", new Token(visible), "vx", new Token(vibX), "vy",
      new Token(vibY), "vz", new Token(vibZ), "vxyz", new Token(vibXyz), "xyz",
      new Token(xyz), };
  ...
  /**
   * retrieves an unsorted list of viable commands that could be completed by
   * this initial set of characters. If fewer than two characters are given,
   * then only the "preferred" command is given (measure, not monitor, for
   * example), and in all cases if both a singular and a plural might be
   * returned, only the singular is returned.
   * 
   * @param strBegin
   *          initial characters of the command, or null
  ...
  public static String getCommandSet(String strBegin) {
    ...
    while (e.hasMoreElements()) {
      ...
      if ((token.tok & command) != 0 && (s == null || name.indexOf(s) == 0)
  ...
  static String[] getTokensLike(String type) {
    int attr = (type.equals("setparam") ? setparam : type.equals("misc") ? misc
  ...
  /*
   * public static String getSetParameters() { String cmds = ""; Enumeration e =
   * map.keys(); while (e.hasMoreElements()) { String name = (String)
   * e.nextElement(); Token token = (Token) map.get(name); if ((token.tok &
   * setparam) != 0) cmds +=name + "\n"; } return cmds; }
   */
