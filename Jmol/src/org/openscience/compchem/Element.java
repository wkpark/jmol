...
public class Element extends Object implements Cloneable{
    
    public String symbol= "";
    public int maxBondOrder = -1;
    public int maxBondOrderSum = -1;
        
    public Element(String symbol, int maxBondOrder, int maxBondOrderSum)
    {
        this.symbol = symbol;
    ...
    public Object clone(){
        Element e = new Element(symbol, maxBondOrder, maxBondOrderSum);
        e.symbol = this.symbol;
        e.maxBondOrder = this.maxBondOrder;
        e.maxBondOrderSum = this.maxBondOrderSum;
        return e;
    }
    
    public String toString(){
        String s = symbol + ": maximum bond order = " + maxBondOrder;
        s += "; maximum sum of bond orders = " + maxBondOrderSum;
        return s; 
    }   
}
