...
abstract public class GenericExport3D {//implements
...
//    try {
//      String name = "org.jmol.export._" + exportName + "Exporter";
...
//    return (exporter.exportType == GData.EXPORT_CARTESIAN ? g3d.clipCode(z)
//        : g3d.clipCode3(x, y, z));
//  }
//
//  @Override
