    ...
    if (halfbw >= 0.5) {
      ...
      case DisplaySettings.SHADING :
        for (int i = (int) (2.0 * halfbw); i > -1; i--) {
          ...
          int red1 = (int) ((float) atom1.getType().getColor().getRed()
                       * (1.0f - len));
          int green1 = (int) ((float) atom1.getType().getColor().getGreen()
                         * (1.0f - len));
          int blue1 = (int) ((float) atom1.getType().getColor().getBlue()
                        * (1.0f - len));

          // Bitwise masking to make color model:
          int model1 = -16777216 | red1 << 16 | green1 << 8 | blue1;

          int red2 = (int) ((float) atom2.getType().getColor().getRed()
                       * (1.0f - len));
          int green2 = (int) ((float) atom2.getType().getColor().getGreen()
                         * (1.0f - len));
          int blue2 = (int) ((float) atom2.getType().getColor().getBlue()
                        * (1.0f - len));
