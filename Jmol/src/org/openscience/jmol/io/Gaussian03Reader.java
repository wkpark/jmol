 ...
 * of Gaussian03.
 *
 * <p>This code is an adaptation of Gaussian98Reader written by
 * Bradley.
 *
 * @author Jonathan C. Rienstra-Kiracofe <jrienst@emory.edu>
 * @author Bradley A. Smith <yeldar@home.com>
 */
public class Gaussian03Reader extends DefaultChemFileReader {

  /**
   * Create an Gaussian03 output reader.
   *
   * @param input source of Gaussian03 data
   */
  public Gaussian03Reader(DisplayControl control, Reader input) {
    super(control, input);
  }

  /**
   * Read the Gaussian03 output.
   *
