...
final public class JmolConstants {
  ...
  public final static String version = "10.9.95"; //various minor rendering fixes; corrects RNA and DNA not correctly selecting phosphorus-only chains; adds visual screen echo for file not found  
