...
final public class JmolConstants {
  ...
  public final static String version = "10.9.72"; //isosurface speed up for planar slices though molecular surface datasets; fix for nullpointer trap in isosurface; preliminary chem3d c3xml reader
