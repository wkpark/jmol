...
public class BMPFile extends Component {
	...
	public void saveBitmap(FileOutputStream fo, Image parImage) {
		this.fo = fo;
		try {
			saveBitmap(parImage, parImage.getWidth(null), parImage.getHeight(null));
	...
	private void saveBitmap(Image parImage, int parWidth, int parHeight) throws IOException {
