...
public class Viewer extends JmolViewer {
  ...
  public String getData(String atomExpression, String type) {
    ...
    if (type.equalsIgnoreCase("PDB"))
      exp = "{selected and not hetero}.label(\"ATOM  %5i  %-3a%1A%3n %1c%4R%1E   %8.3x%8.3y%8.3z%6.2Q%6.2b\")"
          + "+{selected and hetero}.label(\"HETATM%5i  %-3a%1A%3n %1c%4R%1E   %8.3x%8.3y%8.3z%6.2Q%6.2b\")";
