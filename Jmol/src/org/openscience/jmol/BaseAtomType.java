...
public class BaseAtomType {
	 ...
	 */
	public static BaseAtomType get(String name, String root, int atomicNumber, double mass, double vdwRadius, double covalentRadius, Color color) {
	 ...
	 * @param color the color for drawing
	 */
	public void set(String root, int atomicNumber, double mass, double vdwRadius, double covalentRadius, Color color) {
		this.root = root;
	...
	/**
	 * Converts the string into th BaseAtomType.
	 *
