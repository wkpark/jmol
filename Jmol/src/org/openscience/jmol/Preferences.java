...
public class Preferences extends JDialog {
	...
	public JPanel buildGeneralPanel() {
		...
		JLabel mtLabel = new JLabel(jrh.getString("mtExpl"), JLabel.CENTER);
	...
	public JPanel buildDispPanel() {
		...
		JLabel fovLabel = new JLabel(jrh.getString("fovExpl"), JLabel.CENTER);
	...
	public JPanel buildAtomsPanel() {
		...
		renderPanel.setBorder(new TitledBorder(jrh
				.getString("aRenderStyleLabel")));
		...
		labelPanel.setBorder(new TitledBorder(jrh
				.getString("aLabelStyleLabel")));
		...
		propsPanel.setBorder(new TitledBorder(jrh
				.getString("aPropsStyleLabel")));
	...
	public JPanel buildBondPanel() {
		...
		autobondPanel.setLayout(new BoxLayout(autobondPanel,
				BoxLayout.Y_AXIS));
		autobondPanel
				.setBorder(new TitledBorder(jrh.getString("autoBondLabel")));
	...
	public JPanel buildColorsPanel() {
		...
		outlinePanel
				.setBorder(new TitledBorder(jrh.getString("outlineLabel")));
		oButton = new JButton();
		...
		ActionListener startOutlineChooser = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				props.put("outlineColor",
						Integer.toString(outlineColor.getRGB()));
				display.repaint();
		...
		ActionListener startPickedChooser = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				props.put("pickedColor",
						Integer.toString(pickedColor.getRGB()));
				display.repaint();
		...
		ActionListener startVectorChooser = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				props.put("vectorColor",
						Integer.toString(vectorColor.getRGB()));
				display.repaint();
	...
	public JPanel buildVibratePanel() {
		...
		vasPanel.setBorder(new TitledBorder(jrh
				.getString("vibAmplitudeScaleLabel")));
		...
		vvsPanel.setBorder(new TitledBorder(jrh
				.getString("vibVectorScaleLabel")));
	...
	public void ResetPressed() {
		...
		bRender.setSelectedIndex(display.getSettings().getBondDrawMode());
		abYes.setSelected(ChemFrame.getAutoBond());
		bwSlider.setValue((int) (100.0
				* display.getSettings().getBondWidth()));
	...
	void initVariables() {
		...
		ArrowHeadLengthScale =
				new Float(props.getProperty("ArrowHeadLengthScale"))
					.floatValue();
		ArrowHeadRadiusScale =
				new Float(props.getProperty("ArrowHeadRadiusScale"))
					.floatValue();
		BondFudge = new Float(props.getProperty("BondFudge")).floatValue();
		AutoTimeout =
				new Double(props.getProperty("AutoTimeout")).doubleValue();
		BondWidth = new Double(props.getProperty("BondWidth")).doubleValue();
		FieldOfView =
				new Float(props.getProperty("FieldOfView")).floatValue();
		MessageTime =
				new Double(props.getProperty("MessageTime")).doubleValue();
		SphereFactor =
		...
		VibrateAmplitudeScale =
				new Double(props.getProperty("VibrateAmplitudeScale"))
					.doubleValue();
		VibrateVectorScale =
				new Double(props.getProperty("VibrateVectorScale"))
					.doubleValue();
	...
	ItemListener checkBoxListener = new ItemListener() {
		...
		public void itemStateChanged(ItemEvent e) {
			...
			if (cb.getText().equals(jrh.getString("cBLabel"))) {
				...
				props.put("ShowCellAxes",
						new Boolean(ShowCellAxes).toString());
