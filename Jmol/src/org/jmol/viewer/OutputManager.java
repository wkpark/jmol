...
abstract class OutputManager {
  ...
  abstract Object getWrappedState(String fileName, String[] scripts,
                                  Object objImage, boolean asJmolZip);
  ...
  abstract String writeFileData(String fileName, String type, int modelIndex,
                                Object[] parameters);

  abstract JmolOutputChannel getOutputChannel(String localName,
                                              String[] fullPath);
   ...
   *        quality, outputStream, and type-specific parameters
