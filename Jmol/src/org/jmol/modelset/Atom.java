...
//        : group.chain.modelSet.isZeroBased ? atomIndex : atomIndex);
  ...
  /**
   * 
   * @return -1 for acceptor, 1 for donor, 0 for unknown, -2 not
   */
  public int getHbondDonorAcceptorType() {
    switch (getElementNumber()) {
    default:
      return -2;
    case 1:
      if (getCovalentBondCount() == 0)
        return 1;
      switch (bonds[0].getOtherAtom(this).getElementNumber()) {
      case 7:
      case 8:
      case 16:
        return 1;
      ...
      return -2;
    case 7:
      if (this == group.getNitrogenAtom())
        return 1;
      if (group.groupID == JmolConstants.GROUPID_HISTIDINE)
        return 0;
