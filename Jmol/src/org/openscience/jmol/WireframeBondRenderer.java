...
/**
 * Draws bonds as open rectangles colored on each half with the color of the
 * adjacent atom.
 *
 * @author Bradley A. Smith (bradley@baysmith.com)
 */
public class WireframeBondRenderer implements BondRenderer {

  /**
   * Creates an WireframeBondRenderer with default parameters.
   */
  public WireframeBondRenderer() {
  }
  ...
  public void paint(Graphics gc, Atom atom1, Atom atom2,
    ...
    int x1 = (int) atom1.screenX;
    int y1 = (int) atom1.screenY;
    int z1 = (int) atom1.screenZ;
    int x2 = (int) atom2.screenX;
    int y2 = (int) atom2.screenY;
    int z2 = (int) atom2.screenZ;
