...
    return " <small>"
      + GT.escapeHTML(GT._("Page skeleton and JavaScript generated by export to web function using {0} on {1}",
        new Object[] {"<a href=\"http://jmol.sourceforge.net\">Jmol " + jmolViewer.getJmolVersion() + "</a>",
