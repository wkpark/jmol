...
public class Jmol extends JmolPanel {
  ...
  static boolean isSwingJS = /** @j2sNative true|| */
  false;

  public Jmol(JmolApp jmolApp, Splash splash, JFrame frame, Jmol parent,
      int startupWidth, int startupHeight, Map<String, Object> vwrOptions,
      Point loc) {
  ...
  public static Jmol getJmol(JFrame baseframe, int width, int height,
    ...
    jmolApp.info = (vwrOptions == null ? new Hashtable<String, Object>()
        : vwrOptions);
